...
---
# <a name="your-responsibilities-for-office-365-us-government"></a>Ваши обязанности для правительства США Office 365
...
- Измените правила брандмауэра для поддержки определенных диапазонов URL-адресов и IP-адресов, используемых службами Office 365 (при необходимости).
...
- Настройка пространства для совместной работы Microsoft Teams для взаимодействия с партнерами и приглашение членов команды FastTrack Center (недоступны в планах GCC High или DoD).   
