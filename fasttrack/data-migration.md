...
ms.openlocfilehash: 2ec4c7445bea0ed788d1bfa046fd69d87ccf1256
ms.sourcegitcommit: 2dec21801e6272da43cabf4a7eaf044bf2f7d047
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 10/15/2021
ms.locfileid: "60386009"
---
...
> [!NOTE]
> Если вы приобрели или обновили коммерческий план до 9/1/2017, вашим арендаторам потребуется всего 150 лицензий, чтобы иметь право на услуги по миграции данных. В случае планов для образовательных учреждений право на получение доступа к службам переноса данных есть только у преподавателей и персонала с оплаченными лицензиями.
