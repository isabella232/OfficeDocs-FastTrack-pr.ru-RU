...
- Поддержка следующих продуктов:
    ...
    - Виртуализованные приложения, работающие на узле сеансов удаленных рабочих столов в Windows Server и развертываемые в Windows 10 Корпоративная для мультисеансов.
...
- Анализ приложений независимых поставщиков программного обеспечения (ISV) на совместимость с Windows 10 и сведений о поддержке. Дополнительные сведения см. в разделе [Аналитика компьютеров](https://docs.microsoft.com/ru-RU/sccm/desktop-analytics/overview).
