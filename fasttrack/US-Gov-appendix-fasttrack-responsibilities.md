...
ms.locfileid: "29696786"
---
# <a name="fasttrack-responsibilities-for-office-365-us-government"></a>Обязанности эту для Office 365 государственных организаций США.
...
- Вы можете получить помощь по указанным ниже вопросам. 
  ...
  - успешному внедрению и оценке служб.   
...
- Мы оценим имеющуюся инфраструктуру SharePoint Server 2013 или SharePoint Server 2016, в том числе:  
  ...
  - В локальной инфраструктуры проверки готовности к SharePoint Online гибридных функций.  
  - доступ к необходимым конечным точкам SharePoint Online; 
  - Аудитории для OneDrive для бизнеса гибридной среды.    
...
- подключению вашей локальной службы Active Directory с помощью Azure Active Directory:   
  ...
  - Для сред с одним или несколькими лесами:
      - Настройка Azure Active Directory к серверу проверки подлинности, если необходимо (недоступен в планах GCC высокой или министерства обороны США).
      - Настройка Azure Active Directory облегчения единого входа (SSO), если необходимо (недоступен в планах GCC высокой или министерства обороны США).
    > [!NOTE]
...
- Настройка копирования единой системы обмена сообщениями (UM) с Exchange Online (единой системы обмена СООБЩЕНИЯМИ недоступен в планах GCC министерства обороны США). 
...
- Оценка конфигурации инфраструктуры фермы SharePoint в локальной, необходимые для гибридной среды SharePoint Online.    
...
- Настройка локальных сайтов SharePoint для использования функций SharePoint Online гибридного.
...
- Способы настройки SharePoint Online гибридного OneDrive для бизнеса перенаправления (SharePoint 2013 и SharePoint 2016 только).  
...
- Включение телефонной системой (недоступен в планах GCC высокой или министерства обороны США):  
...
- Включение Скайп для бизнеса собрания вещания (недоступен в планах GCC высокой или министерства обороны США):  
