...
- подключению вашей локальной службы Active Directory с помощью Azure Active Directory:   
  ...
  - Для сред с одним или несколькими лесами:
      - Настройка сквозной проверки подлинности Azure Active Directory при необходимости (недоступна в планах GCC High или DoD).
      - Настройка простого единого Sign-On Azure Active Directory (если это необходимо) (отсутствует в планах GCC High или DoD).
    > [!NOTE]
...
- Настройка единой системы обмена сообщениями с Exchange Online (единая система обмена сообщениями недоступна в планах GCC DoD). 
...
- Включение телефонной системы (не доступно в планах GCC High или DoD):  
...
- Включение трансляции собраний Skype для бизнеса (не доступно в планах GCC High или DoD):  
