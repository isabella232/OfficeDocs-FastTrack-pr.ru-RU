...
- Мы оценим имеющуюся инфраструктуру SharePoint Server 2013 или SharePoint Server 2016, в том числе:  
  - необходимые условия для Гибридная среда SharePoint Online;  
  - готовность локальной инфраструктуры для функций Гибридная среда SharePoint Online;  
  - доступ к необходимым конечным точкам SharePoint Online; 
  - аудитории для Гибридная среда OneDrive для бизнеса.    
...
- Настройка локальных сайтов SharePoint для использования функций Гибридная среда SharePoint Online.
