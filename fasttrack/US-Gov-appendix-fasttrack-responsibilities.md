...
ms.locfileid: "51188072"
---
# <a name="fasttrack-responsibilities-for-office-365-us-government"></a>Обязанности FastTrack для правительства США Office 365
...
- подключению вашей локальной службы Active Directory с помощью Azure Active Directory:   
  ...
  - Для сред с одним или несколькими лесами:
      ...
      - Настройка единого единого Sign-On Azure Active Directory (SSO), если это необходимо (не доступно в планах GCC High или DoD).
    > [!NOTE]
...
- Настройка единой системы обмена сообщениями с Exchange Online (единой системы обмена сообщениями недоступна в планах GCC DoD). 
...
- Включение телефонной системы (недоступна в планах GCC High или DoD):  
...
- Включение трансляции skype для деловых собраний (недоступных в планах GCC High или DoD):  
