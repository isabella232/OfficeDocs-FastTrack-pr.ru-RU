...
Подробные сведения о задачах на каждом этапе см. в разделах [Обязанности специалистов FastTrack](fasttrack-responsibilities.md) и [Ваши обязанности](your-responsibilities.md).
...
По вашему заказу специалисты FastTrack проведут оценку исходной среды и требований. Мы соберем данные и поможем оценить требования к пропускной способности, интернет-браузеры, клиентские операционные системы, службу доменных имен (DNS), сеть, инфраструктуру и систему идентификации, чтобы определить, нужны ли изменения перед подключением. 
