...
-   Вы можете получить помощь по указанным ниже вопросам.
    ...
    -   требованиям к DNS, сети и инфраструктуре;

    -   требованиям клиента (веб-браузеру, операционной системе клиента и службам);

    -   удостоверениям пользователей и подготовке;

    -   включению поддерживаемых служб, которые были приобретены и заданы как часть входящей миграции.
