...
<li> Только для Windows 365 и Microsoft Defender для конечных клиентов E5 (Windows 365 облачных ПК).</li>
<li>  Предоставление базовых указаний по безопасности облачных ПК специально для:</li>
<ul>
...
<li> Обучение или руководство по фильтр SmartScreen в Microsoft Defender конфигурации с использованием объектов групповой политики (GPOs), Безопасность Windows или Microsoft Edge.</li>
</li>
<li> Некоторые Windows 365 функций, включая: </li>
<ul>
<li>  Устранение неполадок в управлении проектами Windows развертывания 365.</li>
...
<td>
Требования к включению для Windows 365 включают:
<li>  Microsoft Endpoint Manager как развернутый инструмент управления.</li>
<li>  Все остальные действия Microsoft Defender для FastTrack конечных точек, включая:</li>
<ul><li>  Управление угрозами и уязвимостями.  </li>
<li>  Сокращение направлений атак.  </li>
<li>  Защита нового поколения.  </li>
<li>  EDR.  </li>
<li>  Автоматическое исследование и защита.  </li>
</ul>
</td>
</tr>
...
## <a name="employee-experience"></a>Опыт сотрудников
...
<tbody>
<tr class="even">
<td><strong>Сценарий "Опыт сотрудников" с Microsoft Viva</strong></td>
<td> Microsoft Viva является платформой для взаимодействия сотрудников, которая объединяет коммуникации, знания, обучение, ресурсы и идеи. Питание от Microsoft 365 и опытных в основном через Microsoft Teams, Microsoft Viva способствует культуре, в которой люди и команды уполномочены быть лучшими из любой точки мира. Сценарий "Опыт сотрудников" с Microsoft Viva включает в себя:
<ul><li>  Культура и коммуникации с участием Viva Connections.</li>
<li>  Производительность и благополучие с участием Viva Аналитика.</li>
<li>  Знания и знания с участием Viva Topics.</li>
Мы предоставляем удаленные рекомендации по:
<li>  Подтверждение того, какие модули и функции Microsoft Viva для поддержки бизнес-целей. </li>
<li>  Оценка исходных условий и требований к сценарию. </li>
<li>  Как запустить мастер по опыту работы сотрудников, в частности, какие действия необходимо принять, чтобы привести исходные среды к минимальным требованиям для успешной конфигурации сценария и направлять вас через конфигурацию сценария.</li> </ul>

<strong>Ниже приводится неосякаемая область </strong> 
<ul> 
<li>  Управление проектами клиентов.</li>
<li>  Поддержка на месте.</li> </ul>
</td>

<td><ul>
Microsoft Viva построена поверх используемого пакета Microsoft 365 в настоящее время. Основные развертывания должны включать Office 365, Teams, современные SharePoint и Yammer. Дополнительные сведения о конфигурации сценариев перечислены для каждой соответствующей службы в следующих разделах Microsoft Viva. 
</ul></td>
</tr>
<tr class="odd">
<td><strong>Культура и коммуникации с участием Viva Connections</strong></td>
<td> Культура и коммуникации с участием Viva Connections способствуют созданию значимых подключений, а также развитию культуры интеграции и выравниванию всей организации вокруг вашего видения, миссии и стратегических приоритетов.
Мы предоставляем удаленные рекомендации по:

<ul>
<li> Создание коллекции сайтов из SharePoint службы шаблонов книг.</li>
<li> Брендирование сайта (включая веб-части и аналитику для измерения вовлеченности сотрудников, многоязычной поддержки и внешнего общего доступа).</li>
<li> Настройка структуры новостей (например, сообщений новостей, целевой аудитории, интеграции Yammer).</li>
<li> Настройка домашнего SharePoint, глобальной навигации и панели приложений.</li>
<li> Настройка режима Yammer и создание Yammer сообществ.</li>
<li> Развертывание приложения Viva Connections.</li>
</ul>
 </td>
<td> 
<ul>
<li> Представительное содержимое, которое должно быть ориентировано на аудиторию, должно быть сделано с помощью современных сайтов связи и/или Yammer (Yammer необязательный, но обогащает опыт).</li>
<strong>Примечание:</strong> У многих клиентов нет чистых групп Azure AD или Office 365 групп. Рекомендуется использовать рекомендации для целевых групп.
<li> Назначите домашний сайт для настройки панели мониторинга и навигации ресурсов.</li>
<li> Включить SharePoint и глобальную навигацию.</li>
</ul>
</td>

</tr>
<tr class="even">
<td><strong>Производительность и благополучие с участием Viva Аналитика</strong></td>
<td>  Производительность и благополучие с помощью Viva Аналитика помогает отдельным лицам, руководителям и руководителям бизнеса получать персонализированные сведения и рекомендации. Мы предоставляем удаленные рекомендации по:
<ul>
<li> Назначение лицензий конечным пользователям.</li>
<li> Назначение ролей для администраторов.</li>
<li> Настройка портала администрирования Аналитика Viva</li>
<li> Импорт файла организационных данных для сопоставления пользователей.</li>
<li> Включение приложения Viva Аналитика в Teams (включая установку политик приложений).</li>
</ul>
</td>
<td>  Клиент должен иметь свои почтовые ящики в Exchange Online.</td>
</tr>
<tr class="odd">
<td><strong>Знания и знания с участием Viva Topics</strong></td>
<td> Знания и знания с помощью Viva Topics дают сотрудникам возможность находить ответы и эксперты, а также общаться с другими сотрудниками в своем отделе и за его пределами. Мы предоставляем удаленные рекомендации по:
<ul>

<li> Создание и настройка центра тем.</li>
<li> Понимание роли администратора знаний.</li>
<li> Настройка и управление темами.</li>
<li> Обрезка безопасности веб SharePoint сайтов в Интернете. </li>
<li> Планирование модернизации классических SharePoint страниц. </li>
<li> Использование Yammer для создания сообщества экспертов.</li>
</ul> 
  </td> 
<td> 
<ul>
<li> Основные сайты (точки входа для получения информации) должны быть на современном SharePoint. </li>
<li> Содержимое для знаний должно быть организовано в SharePoint.</li>
</ul></td>
</tr>
</tbody>
</table>
