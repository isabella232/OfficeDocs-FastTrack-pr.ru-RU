...
---
# <a name="onboarding-and-migration-phases-for-office-365-us-government"></a>Этапы миграции и миграции Office 365 для государственных органов США
...
Подробные сведения о задачах для каждого этапа см. в описании обязанностей FastTrack в [office 365 для](US-Gov-appendix-fasttrack-responsibilities.md) государственных органов США и Ваших обязанностей по Office [365 для](US-Gov-appendix-your-responsibilities.md)государственных органов США.
...
Специалисты FastTrack вместе с вами оценят исходную среду и требования. Мы предоставляем инструменты для сбора данных о вашей среде и помощи в оценке требований к пропускной способности и оценке браузеров, клиентских операционных систем, системы доменных имен (DNS), сети, инфраструктуры и системы идентификации, чтобы определить, требуются ли какие-либо изменения для подключения. 
...
- Настройка разделенного доменного сервера между локальной средой Lync 2010, Lync 2013 или серверной средой Skype для бизнеса 2015 и клиентом Skype для бизнеса Online (если применимо).
- Включение планов звонков, трансляции собраний Skype, телефонной системы и планов звонков (на доступных рынках — недоступны в планах GCC High или DoD). 
...
> [!NOTE]
> Следующие данные недоступны в планах GCC High или DoD.
...
- Настройка одного сервера распространения на месте для приложений Microsoft 365, в том числе помощь по созданию configuration.xml файла для использования с средством развертывания Office 365.    
