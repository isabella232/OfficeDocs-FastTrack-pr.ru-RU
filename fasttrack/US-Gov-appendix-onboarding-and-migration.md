...
2.    Выберите пункт **запросить помощь в Microsoft 365** в разделе **быстрые действия** , расположенные в верхней части целевой страницы.
3.    Заполните **запрос помощи в форме Microsoft 365** .
...
1.    Войдите на [сайт FastTrack](https://go.microsoft.com/fwlink/?linkid=780698). 
2.    Выберите пункт **запросить помощь в Microsoft 365** в разделе **быстрые действия** , расположенные в верхней части целевой страницы.
3.    Выполните поиск клиента, введя имя клиента, домен или ТПИД.
4.    Выберите клиент из результатов поиска.
5.    Заполните **запрос помощи в форме Microsoft 365** .
