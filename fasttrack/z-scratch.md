...
<li> Развертывание Cloud App Security как доказательство концепции.</li>
</ul></td>
</tr>
...
<li>  Включение службы ATP в Защитнике Microsoft, объясняя, как развернуть профиль агента ATP с помощью конечной точки на борту.  </li>
...
<li>  Создание политик DLP конечной точки для Windows 10 устройств.  </li>
</ul>
...
<strong>Примечание:</strong> Дополнительные сведения см. в <strong>профиле Azure Information Protection</strong> in <a href="products-and-capabilities.md#enterprise-mobility--security">Enterprise Mobility + Security.</a>
<ul>
