...
- Управление записями.
  ...
  - Руководство по преобразованию планов файлов и расписаний хранения в метки и политики.
...
- Предварительное управление рисками.
  ...
  - Настройка параметров в управлении рисками для предварительной оценки.
  - Создание политик для оценки рисков с помощью встроенной "Playbooks".
  - Настройка разрешений на соответствие условиям взаимодействия.
  - Создание политик обеспечения соответствия для связи с помощью настраиваемых шаблонов.
  - Мониторинг и Просмотр оповещений.
- Управление сведениями.
  - Применение разрешений для управления сведениями.
...
- Создание меток чувствительности.
- Применение меток конфиденциальности. 
- Единая подпись.
- Выученные классификаторы.
- Знание данных с помощью обозревателя контента и обозревателя действий.
- Публикация меток с помощью политик (вручную и автоматически).
- Создание политик защиты от потери данных (DLP) для чатов и каналов Microsoft Teams.
