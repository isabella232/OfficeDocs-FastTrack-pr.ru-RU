...
Вы можете получить помощь по указанным ниже вопросам.
- Управление записями.
  - Применение разрешений для управления записями.
  - Инструкции по преобразованию планов хранения и графиков хранения в метки и политики.
  - Создание меток и политик хранения.
  - Установка политик удаления.
  - Проверка элементов для ликвидации.
- Управление внутренними рисками.
  - Включение журналов аудита Office 365.
  - Настройка параметров в управлении внутренними рисками.
  - Создание политик внутренних рисков с помощью встроенных сборников схем.
  - Настройка разрешений для соответствия требованиям к обмену данными.
  - Создание политик соответствия требованиям к обмену данными с помощью настраиваемых шаблонов.
  - Отслеживание и просмотр оповещений.
- Управление информацией.
  - Применение разрешений для управления информацией.
  - Создание меток хранения.
  - Публикация меток хранения (вручную и автоматически).
  - Создание заданий импорта.
- Advanced eDiscovery.
  - Данные не из Office 365.
...
- Знакомство с данными посредством обозревателя содержимого и обозревателя действий.
- Публикация меток с помощью политик (вручную и автоматически).
- Создание политик защиты от потери данных для чатов и каналов Microsoft Teams.
