...
\*\*\*\*Доступно для облачных служб, которые могут FastTrack преимущества. В противном случае он будет перенаправлен FastTrack специалисту или партнеру.    
...
> [!NOTE]
> Минимальные требования к лицензированию для коммерческих независимых поставщиков программного обеспечения (ISV) для создания Windows 10 приложений нет. Все запросы приложений должны быть ориентированы на версию Windows 10 или Приложения Microsoft 365, которая в настоящее время находится в окне основного обслуживания.

> [!NOTE]
> Право на получение преимущества FastTrack Center зависит от покупки платных лицензий для ранее указанных поддерживаемых планов. В качестве исключения FastTrack помогает с Office 365 E1 с 6 августа по 30 сентября 2021 г. для клиентов, имеющих право на получение лицензии в Индонезии, для оказания помощи в реагировании на текущий всплеск COVID-19. 
