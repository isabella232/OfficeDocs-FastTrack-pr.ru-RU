...
При использовании [соответствующих служб и планов](M365-eligible-services-and-plans.md) для получения Microsoft Azure Active Directory Premium, Microsoft Intune и Azure Information Protection, готовой к использованию, в этом процессе участвуют некоторые этапы. В следующих разделах описывается каждый этап процесса входящей миграции.
...
Базовая входящая миграция включает в себя подготовку служб и интеграцию клиентов и удостоверений. Кроме того, он включает в себя инструкции по предоставлению фундамента для встроенных веб-служб, таких как Azure AD Premium, Intune и Azure Information Protection.
